// Package main is the parent that parks in a child await, for entry 29.
package main
...
// HandleCancelAwaitingParent spawns two children under REQUEST_CANCEL and
...
func HandleCancelAwaitingParent(h cleat.HostCalls, shortMs int, longMs int, tag string) (string, error) {
