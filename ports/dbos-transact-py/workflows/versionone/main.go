// Package main is the FIRST version of the workflow used by the
// version-pinning test. Its twin, workflows/versiontwo, is deployed under the
// same definition name with a higher embedded version.
package main
