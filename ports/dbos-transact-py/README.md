...
|---|---:|---|---:|
| `tests/test_queue.py` | 91 | **1** — concurrency limits, rate limits, dedup, priority | 16 |
...
| **Total** | **109** (4 skipped outright) | **101** credited upstream, **8** cleat-specific |
