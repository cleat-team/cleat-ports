...
| `test_notification_fallback.py` | 2 | `test_failures.py` — upstream test_notification_errors -- delivery must not DEPEND on LISTEN/NOTIFY, since that is what is missing when it fails |
