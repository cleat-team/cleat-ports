...
| [`samples-go`](samples-go/) | [temporalio/samples-go](https://github.com/temporalio/samples-go) | **Apache-2.0** | a different engine's assumptions: signals, queries, timers, child workflows, saga compensation | **17 cases, 13 passing, 4 skipped** (2026-09-07) — 5 findings |
